...
export default function TOC() {
  ...
  return (
    <Nav variant="pills">
      ...
      <NavItem>
        <NavLink href="https://github.com/Rat719/kambaz-next-js">
          My GitHub
        </NavLink>
      </NavItem>
      <a
        href="https://github.com/Rat719/kambaz-node-server-app"
        target="_blank"
      >
        Node Server GitHub
      </a>
      <a
        href="https://kambaz-node-server-app-final-project-pjzf.onrender.com"
        target="_blank"
      >
        Node Server
      </a>
